...
[![GoDoc](https://godoc.org/github.com/ccnlab/leabrax/pbwm1?status.svg)](https://godoc.org/github.com/ccnlab/leabrax/pbwm1)

See [sir2](https://github.com/ccnlab/leabrax/blob/master/examples/sir2) example for working model.
...
The [pbwm.Network](https://godoc.org/github.com/ccnlab/leabrax/pbwm#Network) provides "wizard" methods for constructing and configuring standard PBWM and RL components.
...
[GPiThalLayer](https://godoc.org/github.com/ccnlab/leabrax/pbwm#GPiThalLayer) is source of key GateState:
...
All gated PBWM layers are of type [GateLayer](https://godoc.org/github.com/ccnlab/leabrax/pbwm#GateLayer) which just has infrastructure to maintain `GateState` values and synchronize across layers.

## PFCLayer

[PFCDeepLayer](https://godoc.org/github.com/ccnlab/leabrax/pbwm#PFCDeepLayer) supports `mnt` and `out` types, and handles all the PFC-specific gating logic.
